  ...
  return (
    <section id="globe" className="relative py-20 bg-slate-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-10 items-center">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold text-white">Holographic Worldwide Map</h2>
          <p className="mt-3 text-slate-300">A futuristic, glass-morphic map with cyan/purple glows. Explore regions via luminous hotspots to preview curated stays and sample rates.</p>
          <div className="mt-6 inline-flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white/90 backdrop-blur">
            ...
            Prototype: holographic map — tap hotspots to see curated stays.
          </div>
        </div>
